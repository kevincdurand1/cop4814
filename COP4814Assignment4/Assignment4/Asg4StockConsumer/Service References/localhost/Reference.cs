...
namespace Asg4StockConsumer.localhost {
    ...
    public interface IStockPriceService {
        ...
        Asg4StockConsumer.localhost.StockData GetMovingAverage(int days);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStockPriceService/GetMovingAverage", ReplyAction="http://tempuri.org/IStockPriceService/GetMovingAverageResponse")]
        System.Threading.Tasks.Task<Asg4StockConsumer.localhost.StockData> GetMovingAverageAsync(int days);
    }
    ...
    public partial class StockPriceServiceClient : System.ServiceModel.ClientBase<Asg4StockConsumer.localhost.IStockPriceService>, Asg4StockConsumer.localhost.IStockPriceService {
        ...
        public Asg4StockConsumer.localhost.StockData GetMovingAverage(int days) {
            return base.Channel.GetMovingAverage(days);
        }
        
        public System.Threading.Tasks.Task<Asg4StockConsumer.localhost.StockData> GetMovingAverageAsync(int days) {
            return base.Channel.GetMovingAverageAsync(days);
        }
    }
}
